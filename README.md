# Where In The World App (ReactJS)
...
The project respects responsiveness rules for different screen sizes and uses modern design techniques such as mobile first.
